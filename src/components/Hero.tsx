      ...
      <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] items-center gap-8 md:gap-12">
        ...
        >
          ...
          <p className="mt-6 text-lg md:text-xl text-[var(--fg-muted)] max-w-2xl leading-relaxed">
            I love building software users rely on and removing friction from how they use it. With a background in Customer Success, I care about the what and why, not just the how. Currently at{" "}
            <a
